...
int main(int argc, char** argv){
    FILE *fp_gt, *fp_img;
    // 请自行修改数据集路径
    fp_gt = fopen("/mnt/hgfs/DataSet/EuRoc/V1_01_easy/mav0/state_groundtruth_estimate0/data.csv", "r");
    fp_img = fopen("/mnt/hgfs/DataSet/EuRoc/V1_01_easy/mav0/cam0/data.csv", "r");
    ...
    while (!feof(fp_gt))
    {
        ...
        cv::Mat img;
        string img_file = "/mnt/hgfs/DataSet/EuRoc/V1_01_easy/mav0/cam0/data/" + imgFileNames.front();
